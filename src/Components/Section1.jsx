        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                <div className="md:col-span-4">
                    ...
                    <button className="w-full p-2 bg-green-500 rounded-md mb-4 text-xl text-white"
                        onClick={handleGenerateAvatar}
                    >
                        Generate Avatar
                    </button>
                    <svg className="w-6 h-6 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="hidden md:flex md:col-span-1 items-center justify-center">
                    <button className="flex items-center justify-center bg-blue-500 border-2 border-solid border-blue-600 p-2 rounded-md
                                ...
                                <table className="w-full border-collapse bg-white border-2 border-gray-800 rounded-lg">
                                    <thead>
                                        <tr className="border-b-2 border-gray-800">
                                            <th className="text-left p-3 border-r border-gray-800">Name</th>
                                            <th className="text-left p-3 border-r border-gray-800">Description</th>
                                            <th className="text-left p-3 border-r border-gray-800">Personality</th>
                                            <th className="text-left p-3 border-r border-gray-800">Pics</th>
                                            <th className="text-left p-3">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {characters.map(character => (
                                            <tr key={character.id} className="border-b border-gray-800">
                                                <td className="p-3 border-r border-gray-800">{character.name}</td>
                                                <td className="p-3 border-r border-gray-800">{character.description}</td>
                                                <td className="p-3 border-r border-gray-800">{character.personality}</td>
